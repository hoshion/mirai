exports.run = (client, message) => {
    ...
    const embedAvatar = new Discord.RichEmbed().setDescriprion(`(Ссылка на аватар)[${message.author.avatarURL}]`, null, message.author.avatarURL).setImage(message.author.avatarURL).setColor("ffda8b");
    if(!otherAvatar){
